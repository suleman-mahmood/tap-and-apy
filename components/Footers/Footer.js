				...
				<div className="container mx-auto px-4">
							...
							<div className="flex flex-wrap items-top mb-6">
								<div className="w-full lg:w-4/12 px-4">
									...
									<ul className="list-unstyled">
										<li>
											<a className="text-blueGray-600 hover:text-blueGray-800 hover:cursor-pointer font-semibold block pb-2 text-sm" onClick={showTermsAndConditions}>
												Terms & Conditions
											</a>
										</li>
									</ul>
					...
					<div className="flex flex-wrap items-center md:justify-between justify-center">
						<div className="w-full md:w-4/12 px-4 mx-auto text-center">
							<div className="text-sm text-blueGray-500 font-semibold py-1">Copyright © {new Date().getFullYear()} Notus Tap and Pay.</div>
						</div>
					</div>
				</div>
			</footer>
